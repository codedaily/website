...
kubectl은 Kubernetes 클러스터 매니저를 제어한다.

자세한 정보: https://kubernetes.io/ko/docs/reference/kubectl/overview/
...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">true인 경우, 파일 디렉토리를 헤더에 추가한다.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">파일 뿐만 아니라 표준 에러를 로그로 출력.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">(컨테이너당) 저장할 최대 어플리케이션 수.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">작업할 사용자의 이름</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">작업할 그룹으로, 이 플래그를 반복하여 여러 그룹을 지정할 수 있다.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">Azure 컨테이너 레지스트리 구성정보가 포함된 파일의 경로이다.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">boot-id를 확인할 콤마로 구분된 파일리스트. 존재하는 첫번째를 사용한다.</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">기본 HTTP 캐시 디렉토리</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">인증기관의 인증서 파일 경로</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">TLS의 클라이언트 인증서 파일 경로</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">TLS의 클라이언트 키 파일 경로</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">LB 트래픽 프록시와 상태 확인을 위해 GCE 방화벽에 CIDR이 열림</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">컨테이너 힌트 파일의 위치</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">컨테이너 엔드포인트</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">컨테이너 네임스페이스</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">사용할 kubeconfig 컨텍스트의 이름</td>
    </tr>
    ...
    <tr>
      <td></td><td style="line-height: 130%; word-wrap: break-word;">루트 Cgroup 통계 수집 비활성화</td>
    </tr>
